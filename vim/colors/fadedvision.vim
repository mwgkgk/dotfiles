...
hi Comment      guifg=#008220 guibg=#000000 gui=none ctermfg=034 ctermbg=none cterm=none
...
hi DiffAdd      guifg=#00bf00 guibg=#002200 gui=none ctermfg=034 ctermbg=none cterm=none
...
hi Identifier   guifg=#50d930 guibg=#000000 gui=none ctermfg=028 ctermbg=none cterm=none
...
hi Normal       guifg=#00a900 guibg=#000000 gui=none ctermfg=002 ctermbg=233 cterm=none
...
hi SpecialKey   guifg=#008000 guibg=#002300 gui=bold ctermfg=034 ctermbg=none cterm=bold
hi Statement    guifg=#2fc626 guibg=#000000 gui=none ctermfg=010 ctermbg=none cterm=none
hi StatusLine   guifg=#00ff00 guibg=#102010 gui=none ctermfg=047 ctermbg=022 cterm=bold
