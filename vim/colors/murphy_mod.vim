...
hi CursorColumn    ctermbg=241    cterm=none    guibg=#626262    gui=none
hi CursorLine      ctermbg=241    cterm=none    guibg=#626262    gui=none
hi CursorLineNr    ctermbg=241    cterm=bold    guibg=#626262    gui=none

hi Folded          ctermfg=244    ctermbg=bg    guifg=#808080    guibg=bg
hi FoldColumn      ctermfg=79     ctermbg=241    guifg=#5FD7AF    guibg=#3A3A3A
hi SignColumn      ctermfg=79     ctermbg=241    guifg=#5FD7AF    guibg=#3A3A3A
hi ColorColumn     ctermfg=79     ctermbg=241    guifg=#5FD7AF    guibg=#3A3A3A
