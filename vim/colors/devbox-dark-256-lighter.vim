...
set background=dark
set t_Co=256
let g:colors_name="devbox-dark-256-lighter"
...
" TABS
""""""""""""""""""""""""
hi TabLine          cterm=bold,reverse      ctermfg=0           ctermbg=149
hi TabLineFill      cterm=bold,reverse      ctermfg=0           ctermbg=240
hi TabLineSel       cterm=bold,reverse      ctermfg=149         ctermbg=240
