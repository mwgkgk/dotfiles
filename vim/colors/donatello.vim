...
let g:colors_name = 'donatello'

hi Normal ctermbg=233 ctermfg=118 cterm=none
hi Type ctermfg=118
hi Statement ctermfg=118
hi Constant ctermfg=118
...
hi Search cterm=none ctermbg=118 ctermfg=233
hi IncSearch ctermbg=118 ctermfg=233 cterm=none
...
hi Terminal ctermbg=233 ctermfg=118 cterm=none
