...
if &background=='light' 
  ...
  if &t_Co==256
    ...
    hi StatusLine	ctermfg=fg	ctermbg=220	cterm=NONE
    ...
    if v:version >= 700
      ...
      hi CursorColumn	ctermfg=NONE	ctermbg=188
...
elseif &background=='dark' 
  ...
  if v:version >= 700
    ...
    hi ColorColumn	guifg=NONE	guibg=#555555	gui=NONE
    hi CursorLine	guifg=NONE	guibg=NONE	gui=underline
  ...
  elseif &t_Co==256
    ...
    hi Cursor		ctermfg=16	ctermbg=28	cterm=NONE
    " NOTE THIS IS IN THE COOL SECTION
