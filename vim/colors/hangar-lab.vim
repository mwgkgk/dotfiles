...
hi Comment      guifg=#008220 guibg=#000000 gui=none ctermfg=79 ctermbg=none cterm=none
hi Constant     guifg=#1fc700 guibg=#001c00 gui=none ctermfg=157 ctermbg=none cterm=none
hi Cursor       guifg=#00ff00 gui=bold,reverse ctermfg=48 ctermbg=none cterm=bold,reverse
...
hi Error        guifg=#000000 guibg=#00d000 gui=none ctermfg=13 ctermbg=none cterm=none
hi ErrorMsg     guifg=#000000 guibg=#00ff00 gui=bold ctermfg=13 ctermbg=none cterm=none
...
hi MatchParen   guifg=#304300 guibg=#00fe00 gui=none ctermfg=48 ctermbg=192 cterm=bold
hi ModeMsg      guifg=#00ea00 guibg=#000900 gui=none ctermfg=47 ctermbg=none cterm=none
hi MoreMsg      guifg=#00e700 guibg=#001000 gui=bold ctermfg=47 ctermbg=none cterm=bold
hi NonText      guifg=#008700 guibg=#001000 gui=none ctermfg=237 ctermbg=none cterm=none
hi Normal       guifg=#00a900 guibg=#000000 gui=none ctermfg=83 ctermbg=234 cterm=none
hi Pmenu        guifg=#00bf00 guibg=#000a00 gui=none ctermfg=47 ctermbg=none cterm=none
hi PmenuSbar    guifg=#00dc00 guibg=#001c00 gui=none ctermfg=47 ctermbg=192 cterm=none
hi PmenuSel     guifg=#00f300 guibg=#002200 gui=none ctermfg=48 ctermbg=192 cterm=none
...
hi Special      guifg=#00d700 guibg=#001200 gui=none ctermfg=47 ctermbg=none cterm=none
hi SpecialKey   guifg=#008000 guibg=#002300 gui=bold ctermfg=47 ctermbg=none cterm=bold
hi Statement    guifg=#2fc626 guibg=#000000 gui=none ctermfg=48 ctermbg=none cterm=none
...
hi Title        guifg=#09ab00 guibg=#000000 gui=bold ctermfg=48 ctermbg=none cterm=bold
hi Todo         guifg=#000000 guibg=#00ed00 gui=none ctermfg=000 ctermbg=47 cterm=none
hi Type         guifg=#1fb631 guibg=#000000 gui=none ctermfg=41 ctermbg=none cterm=none
hi Underlined   guifg=#00b400 guibg=#000000 gui=underline ctermfg=47 ctermbg=none cterm=underline
...
hi WarningMsg   guifg=#000000 guibg=#00ff00 gui=none ctermfg=48 ctermbg=none cterm=none
hi WildMenu     guifg=#00cb00 guibg=#000000 gui=reverse ctermfg=000 ctermbg=48 cterm=reverse
