...
nnoremap <buffer> <C-g>g :silent T (documentation '<C-r><C-w> 'variable)<CR>
nnoremap <buffer> <C-g><C-g> :silent T (documentation '<C-r><C-w> 'function)<CR>

nnoremap <buffer> <C-g>G :silent T (documentation '<C-r><C-w> 'compiler-macro)<CR>
